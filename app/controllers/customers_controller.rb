class CustomersController < ApplicationController
  ...
  def signed_in_administrator
    ...
    if signed_in?
      redirect_to customer_home_path, notice: "Only administrators can access those functions"
    else
      redirect_to signin_path, notice: "Please sign in." unless admin_signed_in?
    end
  end
